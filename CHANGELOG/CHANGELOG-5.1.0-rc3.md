...
<a name="v5.1.0-rc3"></a>
## [v5.1.0-rc3](https://github.com/labring/sealos/compare/v5.1.0-rc2...v5.1.0-rc3) (2025-10-15)

### Bug Fixes

* **workflow:** simplify release workflows by using workflow_call and removing redundant steps
* **workflow:** simplify release workflows by using workflow_call and removing redundant steps
...
* **workflow:** add workflow_dispatch trigger and enhance auto-tagging logic
* **release:** update release workflow to trigger on tag pushes
* **release:** update release workflow to trigger on tag pushes
