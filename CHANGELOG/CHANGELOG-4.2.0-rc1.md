...
We are excited to announce the official release of Sealos v4.2.0-rc1 🎉🎉!
...
```shell
    curl -sfL  https://raw.githubusercontent.com/cuisongliu/sealos/v4.2.0-rc1/scripts/install.sh \
    | sh -s v4.2.0-rc1 cuisongliu/sealos
```
...
* 70e1e5c5767b64bb94492d3dca2a5e268d927e2a: docs(main): add changelog action (@cuisongliu)
...
**Full Changelog**: https://github.com/cuisongliu/sealos/compare/v4.2.0-alpha2...v4.2.0-rc1
